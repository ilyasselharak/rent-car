        ...
        <div className="flex h-16 items-center justify-between px-4 border-b">
          {!collapsed && (
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold">{t("RentCar")}</span>
            </Link>
          )}
          {collapsed && <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary mx-auto"><Car className="h-5 w-5 text-primary-foreground" /></div>}
